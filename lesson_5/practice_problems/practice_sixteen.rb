...
Problem: A UUID is a type of identifier often used as a way to uniquely identify items...
...
def generate_UUID
 ...
 p characters
  ...
  sections.each_with_index do |section, index|
    ...
    gino_slices_and_ices = sections.size - 1
    uuid += '-' unless index >= gino_slices_and_ices
  end
