...
PROBLEM
  ...
  - Given a string, write a method 'palindrome_substrings' which returns all the substrings
  from a given string which are palindromes. Consider palindrom words case sensitive. 
...
Algorithm:
            ...
            - create an array named substring_arr that contails all of the substirnig of the input string 
              that are atleast 2 characters long
            - loop through the words in the substring_arr array
            - if the words is a palindrome,append it to the result array
